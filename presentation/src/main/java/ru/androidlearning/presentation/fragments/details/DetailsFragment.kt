...
class DetailsFragment : Fragment(R.layout.fragment_details) {
    private val translatedWord: ru.androidlearning.core.DictionaryPresentationData.TranslatedWord? by lazy { arguments?.getParcelable(ARG_PARAM_TRANSLATED_WORD) }
    ...
    companion object {
        fun newInstance(translatedWord: ru.androidlearning.core.DictionaryPresentationData.TranslatedWord) =
